/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4c9f3d3b26740ad0eecb1fab6c6049be)
// Runtime types generated with workerd@1.20251118.0 2025-11-19 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RaftCluster";
	}
	interface Env {
		TURNSTILE_SECRET_KEY: "1x0000000000000000000000000000000AA";
		GOOGLE_GENERATIVE_AI_API_KEY: string;
		RAFT_CLUSTER: DurableObjectNamespace<import("./src/index").RaftCluster>;
